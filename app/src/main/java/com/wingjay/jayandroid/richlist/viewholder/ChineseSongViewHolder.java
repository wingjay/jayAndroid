 ...
 * @date 2017/09/21
 */
@RichViewHolder(key = "ChineseSongViewHolder")
public class ChineseSongViewHolder implements IRichListViewHolder {
    ...
    public View initView(ViewGroup root) {
        View view = LayoutInflater.from(context).inflate(R.layout.vh_chinese_song, root, false);
